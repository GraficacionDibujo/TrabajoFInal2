...
namespace Proy_Final_v1
{
    public partial class Form1 : Form
    {
        ...
        Pen LapizNegro = new Pen(Color.Black, 5);
        ...
        private void Cuadro_Paint(object sender, PaintEventArgs e)
        {
            ...
            Dibujo.DrawPolygon(LapizNegro, Arreglo1);
            ...
            Dibujo.DrawPolygon(LapizNegro, RectanguloII2);
        ...
        public void DibujarTimon()
        {
            ...
            Dibujo.DrawPath(LapizNegro, Timon);
            ...
            Dibujo.DrawPath(LapizNegro, LineaInteriorTimon);
            ...
            Dibujo.DrawPath(LapizNegro, CirculoInteriorTimon);
            ...
            Dibujo.DrawPath(LapizNegro, PaloTimon2);
            ...
            Dibujo.DrawPath(LapizNegro, FiguraDentroTImon);
            ...
            Dibujo.DrawPath(LapizNegro, AgarreTimon4);
            ...
            Dibujo.DrawPath(LapizNegro, AgarreTimon5);
            ...
            Dibujo.DrawPath(LapizNegro, Circulomano);
            ...
            Dibujo.DrawPath(LapizNegro, PaloTimon3);
            ...
            Dibujo.DrawPath(LapizNegro, PaloTimon4);
            ...
            Dibujo.DrawPath(LapizNegro, PaloTimon5);
            ...
            Dibujo.DrawPath(LapizNegro, LineaMano);
            ...
            Dibujo.DrawPath(LapizNegro, LineaTimon);
            ...
            Dibujo.DrawPath(LapizNegro, LineaTimon2);
            ...
            Dibujo.DrawPath(LapizNegro, LineaTimon3);
            ...
            Dibujo.DrawClosedCurve(LapizNegro, Curvas8.ToArray());
            ...
            Dibujo.DrawClosedCurve(LapizNegro, Curvas9.ToArray());
            ...
            Dibujo.DrawClosedCurve(LapizNegro, Curvas10.ToArray());
            ...
            Dibujo.DrawPath(LapizNegro, PaloTimon);
            ...
            Dibujo.DrawPath(LapizNegro, Lineatimon4);
            ...
            Dibujo.DrawPath(LapizNegro, Lineatimon5);

            Dibujo.DrawLine(LapizNegro, 437, 408, 420, 404);
        ...
        public void DibujarSalvavidas()
        {
            ...
            Dibujo.DrawEllipse(LapizNegro, new Rectangle(1025, 202, diametro2 + 40, diametro2 + 10));
        ...
        public void PrimerosDibujos()
        {
            ...
            RectanguloII[6] = G;
            RectanguloII[7] = A;
            Dibujo.DrawPolygon(LapizNegro, RectanguloII);
        ...
        public void DibujarLadoIzquierdo()
        {
            ...
            PrimerRectantulo.Add(new Point(0, 231));
            Dibujo.DrawPolygon(LapizNegro, PrimerRectantulo.ToArray());
            ...
            SegundoRectangulo.Add(new Point(1, 338));
            Dibujo.DrawPolygon(LapizNegro, SegundoRectangulo.ToArray());
            ...
            Path.CloseFigure();
            Dibujo.DrawPath(LapizNegro, Path);
            ...
            Dibujo.DrawPath(LapizNegro, SegundaForma);
        ...
        public void DibujarCabezaMickey()
        {
            ...
            Curvas10.Add(new Point(782, 141));
            BocaMickey.AddCurve(Curvas10.ToArray(), 1);
            List<Point> Curvas11 = new List<Point>();
            Curvas11.Add(new Point(782, 141));
            ...
            Dibujo.FillPath(BrochaCafe, BocaMickey);
            Dibujo.DrawPath(LapizNegro, BocaMickey);


            GraphicsPath OjoIzquierdo = new GraphicsPath();
            List<Point> Curvas19 = new List<Point>();
            Curvas19.Add(new Point(683, 175));
            Curvas19.Add(new Point(667, 184));
            Curvas19.Add(new Point(660, 203));
            OjoIzquierdo.AddCurve(Curvas19.ToArray(), 1);
            OjoIzquierdo.AddLine(660, 203, 674, 213);
            List<Point> Curvas21 = new List<Point>();
            Curvas21.Add(new Point(674, 213));
            Curvas21.Add(new Point(685, 195));
            Curvas21.Add(new Point(683, 175));
            OjoIzquierdo.AddCurve(Curvas21.ToArray(), 1);
            Dibujo.FillPath(BrochaNegra, OjoIzquierdo);
            Dibujo.DrawPath(LapizNegro, OjoIzquierdo);

            GraphicsPath OjoDerecho = new GraphicsPath();
            List<Point> Curvas22 = new List<Point>();
            Curvas22.Add(new Point(691, 217));
            Curvas22.Add(new Point(698, 199));
            Curvas22.Add(new Point(714, 184));
            OjoDerecho.AddCurve(Curvas22.ToArray(), 1);
            List<Point> Curvas23 = new List<Point>();
            Curvas23.Add(new Point(714, 184));
            Curvas23.Add(new Point(722, 181));
            Curvas23.Add(new Point(724, 186));
            OjoDerecho.AddCurve(Curvas23.ToArray(), 1);
            Dibujo.DrawPath(LapizNegro, OjoDerecho);
        }
    }     
}
